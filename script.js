/*
Read-only Supabase credentials for pulling in publicly-approved incident
submissions. This is the same public anon/publishable key used on
submit.html -- it is meant to be exposed in browser code, and the
database's row-level security policies (not this key) are what actually
restrict it to reading rows where status = 'approved'.
--*/

const SUPABASE_URL = "https://upwnwylhlykrxokvcuhu.supabase.co";
const SUPABASE_ANON_KEY =
	"sb_publishable_c3m71XRj9-VBcnoml2tjVw_2pW4rndB";
